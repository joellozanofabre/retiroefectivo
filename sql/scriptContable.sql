...
VALUES ('RETIRO ATM SIN TARJETA DE DEBITO', @w_nemonico, 'V')
...
BEGIN
    ...
    VALUES (@wus_servicio, 'AHO', 'C', 'NIO', 253, 
            '14',        'REVERSO RETIRO ATM SIN TARJETA DE DEBITO - CREDITO AHORRO CORDOBAS', 
            'S', 'V')
    ...
    VALUES (@wus_servicio, 'AHO', 'D', 'NIO', 264, 
            '17',        'RETIRO ATM SIN TARJETA DE DEBITO - CREDITO AHORRO CORDOBAS', 
            'N', 'V')
    ...
    VALUES (@wus_servicio, 'AHO', 'C', 'USD', 253, 
            '166',       'REVERSO RETIRO ATM SIN TARJETA DE DEBITO - CREDITO AHORRO DOLARES', 
            'S', 'V')
    ...
    VALUES (@wus_servicio, 'AHO', 'D', 'USD', 264, 
            '17',        'RETIRO ATM SIN TARJETA DE DEBITO - CREDITO AHORRO USD', 
            'N', 'V')
    ...
    VALUES (@wus_servicio, 'CTE', 'C', 'NIO', 48, 
            '536',       'REVERSO - RETIRO ATM SIN TARJETA DE DEBITO - CORDOBAS', 
            'S', 'V')
    ...
    VALUES (@wus_servicio, 'CTE', 'D', 'NIO', 50, 
            '507',       'RETIRO ATM SIN TARJETA DE DEBITO - CORDOBAS', 
            'N', 'V')
    ...
    VALUES (@wus_servicio, 'CTE', 'C', 'USD', 48, 
            '446',       'REVERSO RETIRO ATM SIN TARJETA DE DEBITO - DOLARES', 
            'S', 'V')
    ...
    VALUES (@wus_servicio, 'CTE', 'D', 'USD', 50, 
            '447',       'RETIRO ATM SIN TARJETA DE DEBITO - DOLARES', 
            'N', 'V')
END
ELSE
    PRINT 'Error en cabecera de servicio DECAP'
